    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the bell tower of Pisa Cathedral, one of the oldest structures in the city's cathedral square.",
            "Its tilt began during construction due to an unstable foundation, worsening over time before stabilization in the late 20th and early 21st centuries.",
            "The tower stands at approximately 56 meters tall and weighs approximately 14,500 tonnes."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 100,
            "inference_time_tokens": 1113,
            "total_tokens": 1469
      }
}
    ```

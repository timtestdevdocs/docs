    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the bell tower of Pisa Cathedral, and is tilted due to an inadequate foundation.",
            "Construction began in the 12th century and was completed in the 14th century, with the tilt increasing over time.",
            "The tower's height varies between 55.86 and 56.67 meters, and its weight is estimated at 14,500 tonnes."
      ]
}
    ```
    </ResponseExample>

    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the bell tower of Pisa Cathedral, situated in Cathedral Square.",
            "Its tilt began during construction due to an unstable foundation on soft ground.",
            "The tower's tilt increased over centuries until stabilization efforts in the 20th and 21st centuries."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 78,
            "inference_time_tokens": 931,
            "total_tokens": 1265
      }
}
    ```

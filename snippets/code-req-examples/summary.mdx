    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is a bell tower (campanile) of Pisa Cathedral, and the third-oldest structure in the Cathedral Square.",
            "Its tilt, originating from an inadequate foundation on unstable ground, gradually worsened during construction, spanning the 12th to 14th centuries.",
            "Stabilization efforts in recent centuries corrected the tilt, though the tower remains slanted."
      ]
}
    ```
    </ResponseExample>

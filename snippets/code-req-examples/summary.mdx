    ...
    ```json Response
{
      ...
      "summary": [
            ...
            "Its tilt started during the 12th century due to a weak foundation.",
            "The tower's height is approximately 56 meters, and its weight is around 14,500 tonnes."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 66,
            "inference_time_tokens": 1162,
            "total_tokens": 1484
      }
}
    ```

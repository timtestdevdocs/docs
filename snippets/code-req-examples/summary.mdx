    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the bell tower of Pisa Cathedral, and is situated in the city's Cathedral Square.",
            "Its tilt, which began during construction, was caused by an inadequate foundation on unstable ground.",
            "The tower's height varies between 55.86 and 56.67 meters, and its stability was addressed in recent centuries."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 90,
            "inference_time_tokens": 975,
            "total_tokens": 1321
      }
}
    ```

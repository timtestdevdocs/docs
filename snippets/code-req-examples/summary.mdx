    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is a freestanding bell tower (campanile) behind Pisa Cathedral.",
            "Its tilt began during construction due to an unstable foundation.",
            "The tower's tilt worsened over centuries and was stabilized in modern times."
      ]
}
    ```
    </ResponseExample>

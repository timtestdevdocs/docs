    ...
    ```json Response
{
      ...
      "summary": [
            ...
            "Its tilt began during 12th-century construction due to a weak foundation on soft ground.",
            "The tower's height is approximately 55.86-56.67 meters, and it has 294-296 steps."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 74,
            "inference_time_tokens": 1030,
            "total_tokens": 1360
      }
}
    ```

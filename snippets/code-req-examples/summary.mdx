    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the bell tower of Pisa Cathedral, and third oldest structure in the Cathedral Square.",
            "Its tilt began during construction due to a poor foundation on unstable ground.",
            "The tower's tilt gradually increased until stabilized in modern times."
      ]
}
    ```
    </ResponseExample>

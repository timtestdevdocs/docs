    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the bell tower of Pisa Cathedral, situated in the city's Cathedral Square.",
            "Its tilt began during construction due to an unstable foundation on soft ground.",
            "The tower's tilt progressively increased until its stabilization in recent centuries."
      ]
}
    ```
    </ResponseExample>

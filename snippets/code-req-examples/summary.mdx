    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is a freestanding bell tower (campanile) in Pisa, Italy, behind the Cathedral.",
            "Its tilt began during construction due to an unstable foundation on soft ground, and worsened over time before stabilization.",

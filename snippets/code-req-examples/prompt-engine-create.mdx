...
{
      "success": true,
      "prompt_engine_id": "7052a745-3a7f-4151-beb4-ebea76a81bdb",
      "optimized_prompt": "Create an engaging and imaginative story centered around the theme of {about}, incorporating vivid descriptions, relatable characters, and a compelling plot that captivates the reader's attention.",
      "_usage": {
            "input_tokens": 58,
            "output_tokens": 73,
            "inference_time_tokens": 1491,
            "total_tokens": 1622
      }
}
    ```

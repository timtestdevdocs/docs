    ...
    ```json Response
{
      ...
      "result": {
            "outline": [
                  ...
                  {
                        "section": "Defining Your Data Model"
                  },
                  {
                        "section": "Building Your API Endpoints"
                  },
                  {
                        "section": "Implementing Business Logic"
                  },
                  {
                        "section": "Testing Your JigsawStack Application"
                  },
                  {
                  ...
                  {
                        "section": "Choosing a Deployment Platform"
                  },
                  {

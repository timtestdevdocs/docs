...
### 1. Create and execute a reusable prompt (recommended)
...
### 2. Executing the prompt directly
...
- For prompts that will be used multiple times, it is recommended to first [Create](https://docs.jigsawstack.com/api-reference/ai/prompt/create) the prompt and then [Run](https://docs.jigsawstack.com/api-reference/prompt-engine/run) it using the prompt ID for better reliability.
- [Run Prompt Direct](https://docs.jigsawstack.com/api-reference/prompt-engine/run-direct) is ideal for one-time use.

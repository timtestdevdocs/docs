---
title: "Run Prompt"
api: "POST https://api.jigsawstack.com/v1/ai/prompt_engine/{id}"
...
<ParamField body="input_values" type="object">
  The input values. This is required if the `inputs` paramter was specified when
  creating a prompt.
</ParamField>
...
```bash cURL
    curl --location --request POST 'https://api.jigsawstack.com/v1/ai/prompt_engine/{id}' \

...
<ParamField body="file_store_key" type="string">
  ...
  [Storage](https://docs.jigsawstack.com/api-reference/store/file/add). This
  should only be provided when `url` is not specified.
</ParamField>
...
<ParamField body="ocr" type="boolean" defaultValue="true" default="true">
  ...
  the image. The default value is true.
</ParamField>

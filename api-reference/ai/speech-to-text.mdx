...
<ParamField body="language" type="string">
  The language to translate the file into.
</ParamField>

<ParamField body="translate" type="boolean" defaultValue="false">
  Translates the file into the given language.
</ParamField>

<ParamField body="by_speaker" type="boolean" defaultValue="false"></ParamField>

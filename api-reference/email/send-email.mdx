...
<Info>
  Do ensure to configure an email
  [domain](https://docs.jigsawstack.com/api-reference/domain) before sending
  emails.
</Info>
...
<ParamField body="from_name" type="string">
  Sender name. The sender name is used to include a friendly email address. Example: `"Your Name <sender@your-domain.com>"`
</ParamField>
...
<Expandable title="property">
  ...
  <ParamField body="filename" type="string">
   Name of attached file. Should include the file extension. Example `image-name.jpg`
  </ParamField>

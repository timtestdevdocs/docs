...
<ResponseField name="translated_text" type="string | string[]">
  The translated text. The format matches your input:
  - If you sent a single string, you'll receive a single translated string
  - If you sent an array of strings, you'll receive an array of translated strings
</ResponseField>

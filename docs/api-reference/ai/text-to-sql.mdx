...
<ParamField body="prompt" type="string" required>
  The natural language prompt that will be translated to an SQL query.
...
<ParamField body="file_store_key" type="string">
  The key used to store the database schema on Jigsawstack file [Storage](/docs/api-reference/store/file/add). Not required if `sql_schema` is specified.
</ParamField>

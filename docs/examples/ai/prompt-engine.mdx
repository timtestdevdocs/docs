...
- For prompts that will be used multiple times, it is recommended to first [Create](/docs/api-reference/ai/prompt/create) the prompt and then [Run](/docs/api-reference/prompt-engine/run) it using the prompt ID for better reliability.
...
<Info>
  ...
  [here](/docs/api-reference/ai/prompt/create)
</Info>

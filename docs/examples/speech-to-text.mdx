...
description: "Learn how use the Speech to Text API"
---
...
Pass the file key returned from the File [Storage API](https://docs.jigsawstack.com/api-reference/store/file/add).

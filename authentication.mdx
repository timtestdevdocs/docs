...
The JigsawStack API uses API keys to authenticate requests. You can view and manage your API keys in the JigsawStack [dashboard](https://jigsawstack.com/dashboard).
